/**
 * Generador de PDF para Fichas Individuales - Firebase Cloud Functions
 ...
 * @param {string} outputPath - Ruta donde guardar el PDF (debe ser en /tmp/ para Cloud Functions)
 */
    ...
    return new Promise((resolve, reject) => {
        try {
            ...
            doc.fontSize(14)
                ...
                .font("Helvetica-Bold")
                .text("MINISTERIO DE LAS CULTURAS, LAS ARTES Y EL PATRIMONIO", 50, 40, { align: "center" });

            doc.fontSize(10)
                .fillColor(gris)
                .font("Helvetica")
                .text("Gobierno de Chile", 50, 60, { align: "center" });

            doc.fontSize(12)
                .fillColor(azulClaro)
                .font("Helvetica-Bold")
                .text("CÁLCULO DE ASIGNACIÓN MATERNAL RETROACTIVA", 50, 90, { align: "center" });

            // Línea divisoria
            doc.moveTo(50, 110).lineTo(562, 110).stroke(azulOscuro);
            ...
            if (desglose && desglose.length > 0) {
                ...
                doc.text(formatearMoneda(solicitud.monto_total_retroactivo + (solicitud.monto_total_futuro || 0)), colMonto, y);
            }
            ...
            doc.text(`ID Solicitud: ${solicitud.id_solicitud || solicitud.id}`, 50, 730);
